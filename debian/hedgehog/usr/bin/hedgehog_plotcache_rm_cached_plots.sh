...
# 
# File:   hedgehog_plotcache_rm_cached_plots.sh
#
...
SERVERS=`echo "SELECT display_name FROM dsc.server;" | psql -td $DB_NAME`
PLOTS=`echo "SELECT name FROM dsc.visible_plot;" | psql -td $DB_NAME`
